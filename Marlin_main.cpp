    ...
    //     NEW_SERIAL_ERRORLN(gcode_LastN);
       ...
       case 0://A0 GET HOTEND TEMP 
                         ...
                         case 4://A4 GET FAN SPEED 
                          { 
                            unsigned int temp;
                            temp=fan_speed_tft;//(((fanSpeeds[0]+0.5)*100)/Max_ModelCooling);
                ...
                //              else{
                    ...
                    //               }                       
                          ...
                          {    
							  ...
							  fan_speed_tft =0 ; fanSpeeds[0] =0;
							  enqueue_and_echo_commands_P(PSTR("M107")); //2019.8.23 close the fan
                   ...
                   if((!planner.movesplanned())&&(!TFTresumingflag))
                          {
                           ...
                           {
                              if(movespeed>2500)movespeed=600;//���Z���ٶ�����
							  else if(movespeed>1500)movespeed=400;
							  else if(movespeed>200)movespeed = 200;
                              coorvalue=TFTcode_value();
...
inline void gcode_M105() {
 ...
 //   NOMORE(s, 179);
	...
	fan_speed_tft = 100*(fanSpeeds[p]+0.5)/Max_ModelCooling ;
  ...
  inline void gcode_M107() {
    ...
    if (p < FAN_COUNT) {fanSpeeds[p] = 0;fan_speed_tft= 0 ;}
  }
